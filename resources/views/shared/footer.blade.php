...
<footer class="footer appear-animate" data-animation-options="{
    ...
    <div class="footer-newsletter" style="background-color:#591f73;">
        <div class="container">
            <div class="row justify-content-center align-items-center">
                ...
                <div class="col-xl-7 col-lg-6 col-md-9 mt-4 mt-lg-0 ">
                    <form action="#" method="get"
                        ...
                        <button class="btn btn-rounded" type="submit" style="background-color:'white;'">Subscribe<i
    ...
    <div style="background-color:black;">
        <div class="container">
            ...
            <div class="footer-middle" style="border-bottom:none;padding:0px;">
            ...
            <div class="footer-bottom" style="border-bottom:none;">
    ...
    <div class="tab-content">
        <div class="tab-pane active" id="main-menu">
            <ul class="mobile-menu">
                ...
                <li>
                    <i class="w-icon-angle-right"></i><a href="shop-banner-sidebar.html">Shop</a>
                    <ul>
                        <li>
                            <a href="#">Shop Pages</a>
                            <ul>
